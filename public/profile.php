...
<div class="container py-4">
    <div class="row">
        <div class="col-12">
            ...
            <p class="text-muted">Securely connect your Deriv API token to enable automated trading</p>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="card card-dark border-dark-custom">
                <div class="card-body text-center p-5">
                    ...
                    <h2 class="h4 text-white mb-3">🔒 API Token Connected</h2>
        ...
        <div class="col-md-8">
            <div class="card card-dark border-dark-custom mb-4">
                <div class="card-body p-4 p-md-5">
                    <form id="tokenForm">
                        <div class="mb-4">
                            <label for="apiToken" class="form-label text-white fw-semibold">
                                Deriv API Token
                            </label>
...
document.getElementById('tokenForm').addEventListener('submit', async function(e) {
    ...
    try {
        await apiCall('/api/user.php?action=save-token', 'POST', {
            apiToken: token
        });
...
async function handleDisconnect() {
    ...
    try {
        ...
        await apiCall('/api/user.php?action=disconnect-token', 'POST');
