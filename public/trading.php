                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            ...
                            <p class="text-muted mb-0">Real-time trading dashboard</p>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card card-dark border-dark-custom mb-4">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted d-block mt-1" id="botProgressText">Inactive</small>
                    </div>
            ...
            <div class="card card-dark border-dark-custom">
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        <small class="text-muted">Stake:</small>
                        <div class="fw-bold text-white">$<span id="currentStake">1.00</span></div>
                    </div>
                    
                    <div class="mb-2">
                        <small class="text-muted">Target:</small>
                        <div class="fw-bold text-white">$<span id="currentTarget">100.00</span></div>
                    </div>
                    
                    <div class="mb-2">
                        <small class="text-muted">Stop Limit:</small>
                        <div class="fw-bold text-white">$<span id="currentStopLimit">50.00</span></div>
                    </div>
                    
                    <a href="/index.php" class="btn btn-outline-primary btn-sm w-100 mt-3">
                    ...
                    <div class="row g-4">
                        <div class="col-md-3">
                            <div class="text-center p-3 bg-dark rounded">
                                ...
                                <div class="fs-3 fw-bold text-white" id="totalTrades">0</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center p-3 bg-dark rounded">
                                <div class="text-muted small mb-1">Won Trades</div>
                                <div class="fs-3 fw-bold text-success" id="wonTrades">0</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center p-3 bg-dark rounded">
                                <div class="text-muted small mb-1">Lost Trades</div>
...
async function loadTradingData() {
    try {
        const data = await apiCall('/api/trading.php?action=stats');
        ...
        <div class="card bg-dark mb-3 border-dark-custom">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <div class="fw-bold text-white">${trade.asset}</div>
